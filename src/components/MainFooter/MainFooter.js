                ...
                <section className="main-footer-top">
                    ...
                    <header className="main-footer-top-header">
                        ...
                        <nav className="main-footer-top-header-nav">
                            ...
                            <Link className="wow fadeInLeft" data-wow-delay=".9s" data-wow-duration="1.2s" to="/login">Profile</Link>
                            <Link className="wow fadeInLeft" data-wow-delay="1.1s" data-wow-duration="1.2s" to="/discover">Discover</Link>
                            <Link className="wow fadeInLeft" data-wow-delay="1.1s" data-wow-duration="1.2s" href="https://www.termsfeed.com/terms-conditions/03b187ec0a7e3e1daf949a9c83615051" to="/discover">FAQ</Link>
                            <Link className="wow fadeInLeft" data-wow-delay="1.1s" data-wow-duration="1.2s" to="https://www.termsfeed.com/privacy-policy/19ee9e5044a2da9d21da854d0de4f914">Privacy</Link>
                        </nav>
                    </header>
                </section>
                <section className="main-footer-middle">
                    <div className="row wow fadeInLeft" data-wow-delay="0.5s" data-wow-duration="1.2s">
                        <div className="col-sm-4 col-xs-12 hideOnMobile">
                            <p className="title-1">{svg.globe} Partners </p>
