    ...
    return(
      <div className="discover">
        ...
        <header className="discover-header">
          ...
          <form className="discover-header-form" method="GET" action="/">
            ...
            <div className="discover-header-form-container">
              <select className="discover-header-form-container-input select wow fadeInUp" data-wow-delay=".6s" data-wow-duration="3s" onChange={(e) => this.setState({ sortBy: e.target.value })} name="sort_by">
        ...
        <div className="discover-pagination">
          <button className="discover-pagination__button wow fadeIn" data-wow-delay=".5s" data-wow-duration="3s" onClick={() => {this.handlePagination('-'); this.handleGetDiscover(this.props.apiKey, this.state.page)}}>Previous</button>
          <button className="discover-pagination__button wow fadeIn" data-wow-delay=".5s" data-wow-duration="3s" onClick={() => {this.handlePagination('+'); this.handleGetDiscover(this.props.apiKey, this.state.page)}}>Next</button>
        </div>
